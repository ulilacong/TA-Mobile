package com.ulilacong.tauas.ui.fragment
...
import com.ulilacong.tauas.R
import com.ulilacong.tauas.model.DataItemModel
import com.ulilacong.tauas.rest.ApiService
import com.ulilacong.tauas.rest.RetroConfig
        ...
        apiService.getProfil()
            ...
            .subscribe({
                ...
                for (i: Int in items.indices) {
                    ...
                    activity?.let { it1 ->
                        Glide.with(it1).load("https://drive.google.com/file/d/1SsvpaU_NR8jQzL9KH3XZRpf-Pe9ZOhJq/view?usp=sharing" + items.get(i).foto)
                            .override(512, 512).error(R.drawable.acong).into(ivImageProfile)
                    }
                    if (BuildConfig.NPM.equals("16670025")) {
                        nik.text = "Kepo"
                        nisn.text = "Kepo"
                        activity?.let { it1 ->
                            Glide.with(it1).load("https://drive.google.com/file/d/1SsvpaU_NR8jQzL9KH3XZRpf-Pe9ZOhJq/view?usp=sharing")
                                .override(512, 512).error(R.drawable.acong).into(ivImageProfile)
                        }
                    }
                }
